...
class Schoolinfo(TemplateView):
    template_name = 'app_users/schoolinfo.html'
...
class Teachers(CreateView):
    model = Contact
    fields = '__all__'
    template_name = 'app_users/teachers.html'

class Calender(TemplateView):
    template_name = 'app_users/calender.html'
...
class Gaidlines(TemplateView):
    template_name = 'app_users/gaidlines.html'

class Extracur(TemplateView):
    template_name = 'app_users/extracur.html'

class Extracur(TemplateView):
    template_name = 'app_users/extracur.html'

class Library(TemplateView):
    template_name = 'app_users/library.html'
